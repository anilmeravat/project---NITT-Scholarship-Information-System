...
?>
	...
	<h2 style="background-color: #CCCCCC;font:20px/26px cursive;">
		...
		<form action="submit_query.php" method="POST" name="form" >
            
			<?php 
			   if(isset($_SESSION['success_q']))
			   {
				   echo $_SESSION['success_q'];
				   $_SESSION['success_q']="";
				}
			?>          
                ...
                <?php echo $roll?>
				<br>
				<textarea style="width:70%;height:70%;font:24px/30px cursive;" type="text" class="long" name="query" required="required" id="query" placeholder="Write your Query here..."/></textarea><br>
