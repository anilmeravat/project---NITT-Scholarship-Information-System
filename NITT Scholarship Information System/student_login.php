...
<tr>
<th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Sender &nbsp; </th> <th align="center" style="color:#CC0033; border-color:#000000">&nbsp;Sender ID&nbsp;</th><th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Subject &nbsp;</th><th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Message &nbsp;</th><th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Date & Time &nbsp;</th></tr>
<?php

include 'connect.php';
$roll_no=$_SESSION['roll'];
$res=mysql_query("select * from student_inbox where reciever=$roll_no");

while($row=mysql_fetch_array($res))
{

	echo '<tr><td>&nbsp;'.$row['sender_name'].'&nbsp;</td><td>&nbsp;'.$row['sender_id'].'&nbsp;</td><td>&nbsp;'.$row['subject'].'&nbsp;</td><td ><textarea style="width:90%;height:17px; background-image:url("images/bg.jpg");">&nbsp;'.$row['massage'].'</textarea>&nbsp;</td><td>&nbsp;'.$row['sent_time'].'&nbsp;</td></tr>';
