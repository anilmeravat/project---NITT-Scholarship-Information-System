...
?>
	...
	<h2 style="background-color: #CCCCCC;font:15px/21px cursive;">
            ...
            <header>
				...
				<tr>
					<th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Sender &nbsp; </th><th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Suggestions &nbsp;</th><th align="center" style="color:#CC0033; border-color:#000000">&nbsp; Date & Time &nbsp;</th></tr>
<?php
include 'connect.php';
$roll_no=$_SESSION['roll'];
$res=mysql_query("select * from suggestion");

while($row=mysql_fetch_array($res))
{

	echo '<tr><td>&nbsp;'.$row['roll_no'].'&nbsp;</td><td ><textarea style="width:90%;height:17px;">&nbsp;'.$row['sug_msg'].'</textarea>&nbsp;</td><td>&nbsp;'.$row['time_date'].'&nbsp;</td></tr>';
